...
public class AgencyBillReceivedServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String agencyBillPayed = request.getParameter("agencyBillPayed");
		...
		if (null == id) {
			...
			try {
				runtimeService.createMessageCorrelation("billReceivedMessage").processInstanceId(id).setVariable("agencyBillPayed",agencyBillPayed).correlate();
